...
export default function TikTokFollow() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng theo dõi TikTok" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ TikTok", href: "/service/tiktok/tang-theo-doi" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng theo dõi TikTok</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link profile TikTok cần tăng follow
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link profile TikTok cần tăng follow</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng follow cho profile vi phạm chính sách TikTok</li>
