...
export default function TikTokLike() {
    ...
    <AppLayout>
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Dịch vụ TikTok", href: "/service/tiktok/tang-like" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng like TikTok</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link video TikTok cần tăng like
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link video TikTok cần tăng like</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng like cho video vi phạm chính sách TikTok</li>
