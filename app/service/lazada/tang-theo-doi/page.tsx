...
export default function LazadaFollow() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng theo dõi Lazada" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Lazada", href: "/service/lazada/tang-theo-doi" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng theo dõi Lazada</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="https://www.lazada.vn/shop/shopid"
                          required
                        />
                        <div className="form-text">
                          Vui lòng nhập link shop Lazada cần tăng follow
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link shop Lazada cần tăng follow</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng follow cho shop vi phạm chính sách Lazada</li>
