    ...
    <AppLayout>
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Dịch vụ YouTube", href: "/service/youtube/tang-subscribe" },
          { label: "Tăng subscribe", isActive: true }
        ]} 
      />
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng subscribe YouTube</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link kênh YouTube cần tăng subscribe
                        </div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label">
                          <strong>Số lượng subscribe</strong>
                        </label>
                        <input
                          type="number"
                          className="form-control"
                          ...
                          placeholder="Nhập số lượng subscribe muốn tăng"
                          min="100"
                          required
                        />
                        <div className="form-text">
                          Số lượng tối thiểu: 100 subscribe
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link kênh YouTube cần tăng subscribe</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        <li>Kênh phải ở chế độ công khai</li>
                        <li>Không tăng subscribe cho kênh vi phạm chính sách YouTube</li>
                        <li>Hệ thống sẽ tự động kiểm tra và từ chối đơn hàng không hợp lệ</li>
                        <li>Subscribe sẽ được tăng dần trong thời gian đã chọn</li>
                      </ul>
                    </div>
                    ...
                    <div className="card bg-light">
                      <div className="card-body">
                        ...
                        <table className="table table-bordered">
                          <thead>
                            <tr>
                              <th>Loại subscribe</th>
                              <th>Giá (VNĐ)</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td>Subscribe thường</td>
                              <td>50đ/subscribe</td>
                            </tr>
                            <tr>
                              <td>Subscribe chất lượng cao</td>
                              <td>100đ/subscribe</td>
                            </tr>
                            <tr>
                              <td>Subscribe từ tài khoản thật</td>
                              <td>200đ/subscribe</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
