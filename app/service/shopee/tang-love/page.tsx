...
export default function ShopeeLove() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng love Shopee" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Shopee", href: "/service/shopee/tang-love" },
          { label: "Tăng love", isActive: true }
        ]} 
      />
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng love Shopee</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="https://shopee.vn/product/shopid/productid"
                          required
                        />
                        <div className="form-text">
                          Vui lòng nhập link sản phẩm Shopee cần tăng love
                        </div>
                      </div>

                      <div className="mb-3">
                        <label className="form-label">
                          <strong>Số lượng love</strong>
                        </label>
                        <input
                          type="number"
                          className="form-control"
                          ...
                          placeholder="Nhập số lượng love muốn tăng"
                          min="100"
                          required
                        />
                        <div className="form-text">
                          Số lượng tối thiểu: 100 love
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link sản phẩm Shopee cần tăng love</li>
                        <li>Dán link vào ô "Link sản phẩm"</li>
                        <li>Chọn số lượng love muốn tăng</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        <li>Sản phẩm phải ở chế độ công khai</li>
                        <li>Không tăng love cho sản phẩm vi phạm chính sách Shopee</li>
                        <li>Hệ thống sẽ tự động kiểm tra và từ chối đơn hàng không hợp lệ</li>
                        <li>Love sẽ được tăng dần trong thời gian đã chọn</li>
                      </ul>
                    </div>
                      ...
                      <div className="card-body">
                        ...
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Love chất lượng cao</td>
                              <td>10đ/love</td>
                            </tr>
                            <tr>
                              <td>Love từ tài khoản thật</td>
                              <td>20đ/love</td>
                            </tr>
                          </tbody>
                        </table>
