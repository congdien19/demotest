...
export default function FacebookPageLike() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng like page Facebook" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Facebook", href: "/service/facebook/tang-like-page" },
          { label: "Tăng like page", isActive: true }
        ]} 
      />
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng like page Facebook</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link fanpage Facebook cần tăng like
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link fanpage Facebook cần tăng like</li>
                        <li>Dán link vào ô &quot;Link fanpage&quot;</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        <li>Fanpage phải ở chế độ công khai</li>
                        <li>Không tăng like cho fanpage vi phạm chính sách Facebook</li>
