...
export default function FacebookVideoView() {
    ...
    <AppLayout>
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Dịch vụ Facebook", href: "/service/facebook/tang-view-video" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng view video Facebook</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="https://www.facebook.com/username/videos/videoid"
                          required
                        />
                        <div className="form-text">
                          Vui lòng nhập link video Facebook cần tăng view
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link video Facebook cần tăng view</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng view cho video vi phạm chính sách Facebook</li>
