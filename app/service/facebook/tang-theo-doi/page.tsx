...
export default function FacebookFollow() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng theo dõi Facebook" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Facebook", href: "/service/facebook/tang-theo-doi" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng theo dõi Facebook</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        <label className="form-label">
                          <strong>Link profile/page</strong>
                        </label>
                        <input
                          type="text"
                        ...
                        <div className="form-text">
                          Vui lòng nhập link profile hoặc fanpage Facebook cần tăng follow
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link profile hoặc fanpage Facebook cần tăng follow</li>
                        <li>Dán link vào ô &quot;Link profile/page&quot;</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        <li>Profile/Fanpage phải ở chế độ công khai</li>
                        <li>Không tăng follow cho tài khoản vi phạm chính sách Facebook</li>
                      ...
                      <div className="card-body">
                        ...
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Follow từ group</td>
                              <td>15đ/follow</td>
                            </tr>
                            <tr>
                              <td>Follow từ fanpage</td>
                              <td>20đ/follow</td>
                            </tr>
                          </tbody>
                        </table>
