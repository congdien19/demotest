...
export default function FacebookLikePost() {
    ...
    <AppLayout>
      <Breadcrumb 
        ...
        items={[
          ...
          { label: "Dịch vụ Facebook", href: "/service/facebook/tang-like-bai-viet" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng like bài viết Facebook</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link bài viết Facebook cần tăng like
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link bài viết Facebook cần tăng like</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng like cho bài viết vi phạm chính sách Facebook</li>
