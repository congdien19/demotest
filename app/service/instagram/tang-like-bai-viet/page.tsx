...
export default function InstagramLikePost() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng like bài viết Instagram" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Instagram", href: "/service/instagram/tang-like-bai-viet" },
          { label: "Tăng like bài viết", isActive: true }
        ]} 
      />
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng like bài viết Instagram</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link bài viết Instagram cần tăng like
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link bài viết Instagram cần tăng like</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng like cho bài viết vi phạm chính sách Instagram</li>
