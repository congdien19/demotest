...
export default function InstagramFollow() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng theo dõi Instagram" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Instagram", href: "/service/instagram/tang-theo-doi" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng theo dõi Instagram</h4>
              </div>
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link profile Instagram cần tăng follow
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng follow cho profile vi phạm chính sách Instagram</li>
