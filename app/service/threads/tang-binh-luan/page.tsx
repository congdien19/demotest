...
export default function ThreadsComment() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng bình luận Threads" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Threads", href: "/service/threads/tang-binh-luan" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng bình luận Threads</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="https://www.threads.net/@username/post/postid"
                          required
                        />
                        <div className="form-text">
                          Vui lòng nhập link bài viết Threads cần tăng bình luận
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link bài viết Threads cần tăng bình luận</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng bình luận cho bài viết vi phạm chính sách Threads</li>
