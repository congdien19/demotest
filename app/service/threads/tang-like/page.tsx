...
export default function ThreadsLike() {
  ...
  return (
    <AppLayout>
      <Breadcrumb 
        title="Tăng like Threads" 
        items={[
          { label: "congdien.vn", href: "/home" },
          { label: "Dịch vụ Threads", href: "/service/threads/tang-like" },
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Tăng like Threads</h4>
              </div>
                ...
                <div className="row">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-3">
                        ...
                        <div className="form-text">
                          Vui lòng nhập link bài viết Threads cần tăng like
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="alert alert-info">
                      ...
                      <ol>
                        <li>Sao chép link bài viết Threads cần tăng like</li>
                    ...
                    <div className="alert alert-warning">
                      ...
                      <ul>
                        ...
                        <li>Không tăng like cho bài viết vi phạm chính sách Threads</li>
